                    ...
                    <Board onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "32px", alignItems: "center" }}>
                            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                                <Text_Type variant="h2">CAPÍTOL I</Text_Type>
                                <Text_Type variant="t2B">EL CAVALLER</Text_Type>
                            </div>
                            <img src="/imatges_capitols/CAP_I.svg" width={172}></img>
                            <Text_Type variant="bodyL">Começa la jornada. El Consell de Cent t’espera...pero hauràs de trobar el camí per tu sol.</Text_Type>
